...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    getInitialInfo();
    return Scaffold( // --> Framework que da accesso a muchos widgets
      appBar: appBar(),
          ...
          children: [
            ...
            Container(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) { // --> Es como un "mapa" de items
                  return Container(
                    width: 100,
                    decoration: BoxDecoration(
  ...
  Container searchField() {
    return Container(
          ...
          child: TextField( // --> Permite al usuario escribir
  ...
  AppBar appBar() {
    return AppBar(
      ...
      backgroundColor: Colors.white,
      elevation: 0.0, // --> Saca la sombra en este caso del appBar
      centerTitle: true,
      ...
      actions: [
        GestureDetector( // --> Hacen los botones clickeables
          onTap: () {
